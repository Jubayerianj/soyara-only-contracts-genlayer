# SoyaraDex V3 Bug Bounty

## Overview

Starting on March 23rd, 2021, the [uniswap-v3-core](https://github.com/Uniswap/uniswap-v3-core) repository is subject to the SoyaraDex V3 Bug Bounty (the “Program”) to incentivize responsible bug disclosure.
...
- Bugs in any third party contract or platform that interacts with SoyaraDex V3.
- Vulnerabilities already reported and/or discovered in contracts built by third parties on SoyaraDex V3.
...
SoyaraDex V3 was developed with the following assumptions, and thus any bug must also adhere to the following assumptions
...
- Discover a previously unreported, non-public vulnerability that would result in a loss of and/or lock on any ERC-20 token on SoyaraDex V3 (but not on any third party platform interacting with SoyaraDex V3) and that is within the scope of this Program. Vulnerabilities must be distinct from the issues covered in the Trail of Bits or ABDK audits.
...
- Make a good faith effort to avoid privacy violations, destruction of data, interruption or degradation of SoyaraDex V3.
